...
from Signal import signal_class, reconstructed_signal_class, whittaker_shannon_interpolation
...
def plot_original_signal(data_x, data_y, amplitude, first_plot, color, signal_id):
    signal = signal_class(data_x, data_y,'original', amplitude, first_plot, color, len(signals_list) + 1, signal_id)
